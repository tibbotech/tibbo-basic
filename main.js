...
//**************************************************************************************************
    ...
    //PLATFORM CONSTANT. Vertical.
    //PLATFORM CONSTANT. Horizontal.
...
//ser.redir and sock.redir methods.
    //INTER-OBJECT CONSTANT. Cancels redirection for the serial port or socket.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of the serial port 0.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of the serial port 0.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of the serial port 1.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of the serial port 2.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of the serial port 3.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 0.
                        //This constant can be used as a "base" for all other sockets i.e. in expressions like sock.redir=PL_REDIR_SOCK0+f.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 1.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 2.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 3.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 4.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 5.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 6.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 7.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 8.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 9.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 10.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 11.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 12.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 13.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 14.
    //INTER-OBJECT CONSTANT. Redirects RX data of the serial port or socket to the TX buffer of socket 15.
...
//--------------------------------------------------------------------
    ...
    //<b>PLATFORM CONSTANT. </b><br><br> Monday.
    //<b>PLATFORM CONSTANT. </b><br><br> Tuesday.
    //<b>PLATFORM CONSTANT. </b><br><br> Wednesday.
    //<b>PLATFORM CONSTANT. </b><br><br> Thursday.
    //<b>PLATFORM CONSTANT. </b><br><br> Friday.
    //<b>PLATFORM CONSTANT. </b><br><br> Saturday.
    //<b>PLATFORM CONSTANT. </b><br><br> Sunday.
...
//--------------------------------------------------------------------
    ...
    //<b>PLATFORM CONSTANT. </b><br><br> January.
    //<b>PLATFORM CONSTANT. </b><br><br> February.
    //<b>PLATFORM CONSTANT. </b><br><br> March.
    //<b>PLATFORM CONSTANT. </b><br><br> April.
    //<b>PLATFORM CONSTANT. </b><br><br> May.
    //<b>PLATFORM CONSTANT. </b><br><br> June.
    //<b>PLATFORM CONSTANT. </b><br><br> July.
    //<b>PLATFORM CONSTANT. </b><br><br> August.
    //<b>PLATFORM CONSTANT. </b><br><br> September.
    //<b>PLATFORM CONSTANT. </b><br><br> October.
    //<b>PLATFORM CONSTANT. </b><br><br> November.
    //<b>PLATFORM CONSTANT. </b><br><br> December.
...
const DEVICE_NET_IP = "192.168.1.137";
const MAX_NUM_INTERFACES = 4;




let interface_ready = new Array(MAX_NUM_INTERFACES);


app.on_sys_init = function() {
    boot();
}
...
app.on_sock_data_arrival = function() {
...
function foo_struct() {//structure with two members, and both are arrays  
	this.x;
	this.s;
};
...
function boot() {
	...
	let hh = 0.123;
	let ii = "aabbcc";
	let jj = PL_WLN_OWN_NETWORK;
	let ll = new foo_struct();
	ll.x = 9;
	ll.s = "bcd";
