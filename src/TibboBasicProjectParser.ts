...
class ParserListener extends TibboBasicParserListener {
    ...
    enterParam(ctx: any) {
        ...
        let valueType = 'void';
        let length = '';
        ctx.children.forEach((element: any) => {
